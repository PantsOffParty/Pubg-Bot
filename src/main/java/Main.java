...
public class Main extends ListenerAdapter {
    ...
    public void onMessageReceived(MessageReceivedEvent event) {
        ...
        //display all winning coordinates for a given map
        if (messageText.contains("!allwin"))
        {
            ...
            try {
                ...
                event.getChannel().sendMessage("You have not captured a win for this map because you suck.").queue();
            }
        }
    ...
    private BufferedImage getAllWinCoordinatesImage(String mapKey) throws IOException {
        ...
        try (BufferedReader br = new BufferedReader(new FileReader(System.getenv("USERPROFILE") +
